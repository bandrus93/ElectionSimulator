...
public class DisplayManager {
    public static final String GREETING_MESSAGE = "Welcome to Arlandia! What would you like to do?" +
    ...
    public static final String CAMPAIGN_COMMAND_LIST = """
            ...
            When you are finished making changes to the ballot roster, you may run the election by:
            Entering 'p' to run a plurality election;
            Entering 'r' to run an instant-runoff(ranked-choice) election;
            Entering 'a' to run an approval election.
            """;
